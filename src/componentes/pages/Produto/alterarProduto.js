...
const fetchProdutoPorId = async (id) => {
    try {
        const response = await fetch(`http://localhost:3000/produtos/getProdutoPorId/${id}`);
...
export default function AlterarProduto() {
    ...
    useEffect(() => {
        const buscarCategorias = async () => {
            try {
                const response = await fetch("http://localhost:3000/categorias/getCategorias");
        ...
        const carregarProduto = async () => {
            try {
                ...
                setFormDados({
                    ...
                    preco_produto: data.preco_produto ? data.preco_produto.toString() : '',
   ...
   const handleInputChange = (e) => {
    ...
    if (loading) {
        return <Container style={{ paddingTop: "50px", textAlign: "center" }}>
                ...
                <div className="d-flex" style={{ justifyContent: "center" }}>
                    <div className="mb-3" style={{ width: "60%" }}>
                        ...
                        <input
                            ...
                            style={{ backgroundColor: "#fef5c8", fontFamily: "Josefin Slab, serif"}}
                            name="nome_produto"
